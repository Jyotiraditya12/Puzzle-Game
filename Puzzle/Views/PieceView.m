...
@synthesize image, number, thisEdges, position, angle, size, tempAngle, padding, delegate, neighbors, oldPosition, centerView, positionInDrawer, group;
...
- (void)drawRect:(CGRect)rect {
    ...
    for (int i=1; i<5; i++) {
        int e = [[thisEdges objectAtIndex:i-1] intValue];
...
-(int)edgeNumber:(int)i {
    ...
    return [[thisEdges objectAtIndex:i] intValue];
}
