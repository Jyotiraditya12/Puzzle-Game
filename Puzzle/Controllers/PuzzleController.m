        ...
        for (int i=0;i<pieceNumber;i++){
            for (int j=0;j<pieceNumber;j++){
                ...
                if (pieceDB!=nil) {
                    ...
                    piece.thisEdges = [NSArray arrayWithArray:a];
        ...
        for (int i=0;i<pieceNumber;i++){
            ...
            for (int j=0;j<pieceNumber;j++){
                ...
                if (i>0) {
                    ...
                    int e = [[[[arrayPieces objectAtIndex:l] thisEdges] objectAtIndex:1] intValue];
                    [a replaceObjectAtIndex:3 withObject:[NSNumber numberWithInt:-e]];
                    //DLog(@"e = %d", e);
                }
                
                if (j>0) {
                    int e = [[[[arrayPieces lastObject] thisEdges] objectAtIndex:2] intValue];
...
- (void)updatePieceDB:(PieceView*)piece {
    ...
    pieceDB.edge0 = [piece.thisEdges objectAtIndex:0];
    pieceDB.edge1 = [piece.thisEdges objectAtIndex:1];
    pieceDB.edge2 = [piece.thisEdges objectAtIndex:2];
    pieceDB.edge3 = [piece.thisEdges objectAtIndex:3];
