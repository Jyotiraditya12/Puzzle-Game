        ...
        if (!delegate.loadingGame) {
            ...
            for (int i=0;i<pieceNumber;i++){
                ...
                for (int j=0;j<pieceNumber;j++){
                    ...
                    pieceDB.edge0 = [[[delegate pieceWithNumber:j+pieceNumber*i] thisEdges] objectAtIndex:0];
                    pieceDB.edge1 = [[[delegate pieceWithNumber:j+pieceNumber*i] thisEdges] objectAtIndex:1];
                    pieceDB.edge2 = [[[delegate pieceWithNumber:j+pieceNumber*i] thisEdges] objectAtIndex:2];
                    pieceDB.edge3 = [[[delegate pieceWithNumber:j+pieceNumber*i] thisEdges] objectAtIndex:3];
